...
class CodeQueryTest {
    ...
    @Test
    fun limit(){
        query.limit(1).get().addOnSuccessListener {
            var nb = 0
            for (i in it) {
                ++nb
                assertEquals(i.id, i.data["i"].toString())
    ...
    @Test
    fun whereEqualTo(){
        query.whereEqualTo("i", 1).get().addOnSuccessListener {
            var nb = 0
            for (i in it) {
                ++nb
    ...
    @Test
    fun whereNotEqualTo(){
        query.whereNotEqualTo("i", 1).get().addOnSuccessListener {
            var nb = 0
            for (i in it) {
                ++nb
    ...
    fun whereArrayContains(){
        query.whereArrayContains("l", 1).get().addOnSuccessListener {
            var nb = 0
            for (i in it) {
                ++nb
                assertEquals(1, i.data["i"])
    ...
    fun whereGreaterThan(){
        query.whereGreaterThan("i", 1).get().addOnSuccessListener {
            var nb = 0
            for (i in it) {
                ++nb
    ...
    @Test
    fun whereLessThan(){
        query.whereLessThan("i", 1).get().addOnSuccessListener {
            var nb = 0
            for (i in it) {
                ++nb
    ...
    fun whereGreaterThanOrEqualTo(){
        query.whereGreaterThanOrEqualTo("i", 1).get().addOnSuccessListener {
            var nb = 0
            for (i in it) {
                ++nb
    ...
    fun whereLessThanOrEqualTo(){
        query.whereLessThanOrEqualTo("i", 1).get().addOnSuccessListener {
            var nb = 0
            for (i in it) {
                ++nb
